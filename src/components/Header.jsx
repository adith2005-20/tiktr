  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        location.pathname === '/' && !isScrolled ? 'bg-transparent' : 'bg-black/40 shadow-lg backdrop-blur-md'
      }`}
    >
            ...
            {walletAddress ? (
              <div className="relative">
                <button
                  ...
                  className="bg-orange-700 hover:bg-orange-600 text-white font-medium py-2 px-4 rounded-xl transition-colors"
                >
            ...
            <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
              <li>
                <NavLink
                  to="/"
                  className={({ isActive }) =>
                    `${isActive ? 'text-orange-600 font-bold' : 'text-white'} block py-2 pr-4 pl-3 duration-200 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 hover:text-orange-700 lg:p-0`
                  }
                  onClick={() => { window.scrollTo(0, 0); }}
                >
                  Home
