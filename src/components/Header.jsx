            ...
            <nav className="bg-black border-gray-200 px-4 lg:px-6 py-2.5 text-white">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        <Link
                            to="#"
                            className="text-gray-300 font-serif hover:text-white focus:ring-4 focus:ring-gray-300 font-extralight rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none"
                        >
                            Log  in
                        </Link>
                        <Link
